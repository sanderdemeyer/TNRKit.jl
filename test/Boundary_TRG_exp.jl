...
stopping_criterion_boundary = maxiter(40)&convcrit(1e-20, bound_trg_env)&convcrit(1e-20, bound_trg_blk)
...
data_boundtrg = run!(scheme, truncdim(16) ,stopping_criterion_boundary; finalize_beginning=true)