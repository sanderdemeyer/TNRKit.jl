...
function calculate_projectors(scheme::CTM_honeycomb, trunc)
    ...
    projectors_simul = [calculate_projector_simultaneous(σs, trunc, dir) for dir = 1:3]
    projectors = [projectors_simul[dir][1:2] for dir = 1:3]
    Ss = [projectors_simul[dir][3] for dir = 1:3]
    for dir = 1:3
