...
function step!(scheme::Boundary_TRG, trunc::TensorKit.TruncationScheme)
    ...
    @tensor temp_E1[-1 -2; -3] := temp_bound_north[-1 1 2; -3]*Proj_1[2 1; -2]
    @tensor bulk_env[-1 -2; -3 -4] := temp_bulk[-1 1 2; -3 3 4]*Proj_3[2 1; -2]*Proj_2[4 3; -4]
    @tensor bulk_temp[-1 -2; -3 -4] := temp_bulk[-1 1 2; -3 3 4]*Proj_3[2 1; -2]*Proj_2[4 3; -4]
